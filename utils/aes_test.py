...
if __name__ == '__main__':
    ...
    print("加密前：%s" % a)
    b = pc.encrypt(a)
    c = pc.decrypt('D7AD39D4AB776EA75F4B0EA1E8BFF211EECEF579DD517A2CBC3A6C1C0573C20644AFDA64A9C02F3CDC6CBAA388'
                   '83C594EC40AA90CE6CB751FA1456D845A78A55E69E008792F13ED1B352861765AB4C1A')
    print('解密后:{}'.format(c))
    print("加密后：%s" % b)
